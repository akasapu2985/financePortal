...
export const WatchlistItem = ({ instrument, isSelected, onSelect }: WatchlistItemProps) => {
  ...
  return (
    <button
      ...
      className={[
        'group relative grid min-h-14 grid-cols-[minmax(0,1.4fr)_minmax(84px,0.9fr)_minmax(72px,0.8fr)_56px] items-center gap-3 overflow-hidden rounded-xl border border-transparent px-3 py-2 text-left transition-colors',
